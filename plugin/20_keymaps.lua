...
nmap_leader('fD',    '<Cmd>FzfLua diagnostic_document<CR>',               'Diagnostic buffer')
nmap_leader('ff',    '<Cmd>FzfLua files resume=true<CR>',                 'Files')
nmap_leader('fg',    '<Cmd>FzfLua live_grep resume=true<CR>',             'Grep live')
nmap_leader('fG',    '<Cmd>FzfLua grep_cword<CR>',                        'Grep word under cursor')
nmap_leader('fh',    '<Cmd>FzfLua helptags resume=true<CR>',              'Help tags')
...
nmap_leader('fm',    '<Cmd>FzfLua marks<CR>',                             'Modified hunks (all)')
nmap_leader('fM',    '<Cmd>FzfLua man_pages resume=true<CR>',             'Modified hunks (all)')
...
nmap_leader('fp',    '<Cmd>FzfLua projects<CR>',                          'Projects')
nmap_leader('fR',    '<Cmd>FzfLua lsp_references resume=true<CR>',        'References (LSP)')
nmap_leader('fs',    '<Cmd>FzfLua lsp_workspace_symbols resume=true<CR>', 'Symbols workspace')
nmap_leader('fS',    '<Cmd>FzfLua lsp_document_symbols resume=true<CR>',  'Symbols document')
nmap_leader('fp',    '<Cmd>FzfLua lsp_finder resume=true<CR>',            'All LSP locations')
nmap_leader('fv',    '<Cmd>FzfLua jumps<CR>',                             'Visit paths (all)')
